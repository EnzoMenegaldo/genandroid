...
/**
 * This is the item provider adapter for a {@link genandroid.DataAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataAssociation_references_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataAssociation_references_feature", "_UI_DataAssociation_type"),
				 GenandroidPackage.Literals.DATA_ASSOCIATION__REFERENCES,
				 true,
				 false,
				 true,
				 null,
